                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="flex justify-center text-teal-600 sm:justify-start dark:text-teal-300">
                           <Image src="/assets/logo.svg" alt="Arrow Banking Logo" width={124} height={124} className="w-6 h-6" />
                            <p>Arrow Banking</p>
                        </div>
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 text-gray-700 dark:text-gray-300"> Email: support@arrowbanking.com </span>
                                    </a>
                                </li>
